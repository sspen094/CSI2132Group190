      ...
      <div class="row" id="row">
        <div class="col-md-12">
          <form
            ...
            name="employy-form"
            action="insert-employee-controller.jsp"
            method="POST"
          >
            ...
            <div class="form-group col-sm-3 mb-3">
                ...
                <div class="form-group col-sm-3 mb-3">
                    <label for="works">Works For</label>
                    <input
                      type="text"
                      class="form-control"
                      name="works"
                ...
                <div class="form-group col-sm-3 mb-3">
                    <label for="manages">Manages</label>
                    <input
                      type="text"
                      class="form-control"
                      name="manages"
        ...
        <div class="row" id="rowb">
            ...
            <div class="col-md-12">
              <form
                class="form-horizontal"
                name="customer-form"
                action="update-employee-controller.jsp"
                method="POST"
              >
              <div class="form-group col-sm-3 mb-3">
